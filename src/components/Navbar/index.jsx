        ...
        <div className="container-fluid px-0">
            ...
            <div className="collapse ms-5 navbar-collapse justify-content-end w-100" id="navbarSupportedContent">
                <ul className="navbar-nav mb-lg-0 d-flex justify-content-between w-100">
                    ...
                    <li className="nav-item d-block">
                        <button className="bg-transparent nav-link" onClick={()=>navigate("/order-history")}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" className="bi bi-clock-history" viewBox="0 0 16 16">
